...
// Server-side guard: when the dashboard has no relevant cell, skip the LLM
// entirely and return the fixed refusal.  This guarantees the refusal rule
// is honoured even if the model would otherwise paraphrase.
